    ...
    <div className={nav || search ? 'bg-[#1D1D1D] text-white pt-10 laptop:pt-0' : 'bg-[#1D1D1D] text-white' }>
      <div className='flex flex-nowrap justify-start gap-4 bg-cover bg-no-repeat bg-[#2b2b2b] bg-blend-overlay laptop:gap-8' style={{backgroundImage: `url(${LONG_IMAGE_URL}${moviedetails?.backdrop_path})`}}>
          <div className='ml-3 py-10 laptop:ml-14 laptop:py-14 desktop:ml-16 desktop:py-16'>
            {
              imageloading ? <img src={iBommaMovieContent} alt={moviedetails?.original_title} loading="lazy" className='bg-[#252525] rounded-md shadow-lg w-[165px] h-[240px] laptop:w-[235px] laptop:h-[360px]'/> :
            ...
            {
              // imageloading && <img src={moviedetails?.poster_path ? LONG_IMAGE_URL + moviedetails?.poster_path : PosterNotAvailable} width="230" height="345" alt={movie?.original_title} loading="lazy" onLoad={handleImageLoad} style={{"display": 'none'}} className='bg-[#252525] rounded'/>
              <img src={moviedetails?.poster_path ? LONG_IMAGE_URL + moviedetails?.poster_path : PosterNotAvailable} alt={moviedetails?.original_title} loading="lazy" onLoad={handleImageLoad} style={{"display": 'none'}} className='bg-[#252525] rounded-md shadow-lg w-[165px] h-[240px] laptop:w-[235px] laptop:h-[360px]' /> 
