...
const Header = () => {
  ...
  return (
    <div className='bg-[#252525] text-white flex items-center justify-between border-[#3e3e3e] border-b-[0.5px] laptop:flex flex-row items-center justify-between'>
        ...
        <div>
            <Link to="/">
                {/* <img src="https://raw.githubusercontent.com/Siva-Tejaa/Projects-Data/main/ibommalogo.png" alt="iBommaLogo" className='laptop:pl-4 desktop:pl-16'/> */}
                <svg alt="iBOMMA" id="logo" version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="160px" height="64px" viewBox="0 0 112.000000 45.000000"
 preserveAspectRatio="xMidYMid meet" className='laptop:pl-4 desktop:pl-4'>
<g transform="translate(0.000000,45.000000) scale(0.007467,-0.007500)" fill="#6ac045" stroke="none"><path d="M822 4173 c-43 -21 -52 -56 -21 -89 22 -23 27 -24 160 -24 128 0 139
